...
function renderMini(){injectMini();const m=$('#eliasMiniPlayer'),t=current();safeImg($('img',m),t.art);$('strong',m).textContent=t.title;$('b',m).textContent=audio.paused?'▶':'Ⅱ';m.classList.toggle('playing',!audio.paused)}
